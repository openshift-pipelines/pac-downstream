...
LABEL \
    com.redhat.component="openshift-pipelines-pipelines-as-code-webhook-rhel10-container" \
    ...
    name="openshift-pipelines/pipelines-pipelines-as-code-webhook-rhel10" \
