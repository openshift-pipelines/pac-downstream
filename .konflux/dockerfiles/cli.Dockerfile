...
ARG RUNTIME=registry.access.redhat.com/ubi8/ubi-minimal:latest@sha256:48adecc91f276734fa51987bc2203a31db9ba87a512c436c0a3fcac53135378d
...
RUN CGO_ENABLED=0 go build -mod=vendor -tags disable_gcp -v  \
